...
CREATE TABLE stock_item (
  stock_item_id INT(10) AUTO_INCREMENT,
...
--
CREATE TABLE sale (
  sale_id INT(10) AUTO_INCREMENT,
  `date` DATE NOT NULL,
  stock_item_id INT(10) NOT NULL,
...
--
-- Table structure for table stock_item_log
--
CREATE TABLE stock_item_log (
  stock_item_log_id INT AUTO_INCREMENT,
  `action` CHAR(6),
